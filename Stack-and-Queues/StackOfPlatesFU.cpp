//
// Created by wangxing on 19-7-22.
//

// 实现函数pop(int index),它在指定的子堆栈上执行pop操作
...
// Special case if capacity is 1, In this case popAt(index) makes a specified sub-stack empty,
